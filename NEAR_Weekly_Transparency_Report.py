...
st.title('Near Weekly Transparency Report')
...
st.markdown('Each week, the NEAR Foundation publishes publish data to help the NEAR community understand the health of the ecosystem as part of their Transparency Report.')

st.markdown('One of the main aspects to consider for these type of L1 blockchains is the competence. Users are constantly choosing for the best network to act and to use considering several aspects such as speed, success transactions, performance etc.')


# In[5]:


st.markdown('The intention of this analysis is to provide information about the current status of Near Protocol network activity by providing metrics such as:') 
st.write('- New users')
...
group by 1
  ...
  t2 as (
  SELECT
  distinct tx_signer,debut from t1 where debut >=CURRENT_DATE-INTERVAL '1 MONTH'
  )
  select 
...
st.subheader('New and active Near users')
...
st.write('- Last month new users (daily and cumulative)')
...
# Set y-axes titles
fig1.update_yaxes(title_text="Hourly new Near users", secondary_y=False)
fig1.update_yaxes(title_text="Total new Near users", secondary_y=True)
...
# Set y-axes titles
fig2.update_yaxes(title_text="Daily new Near users", secondary_y=False)
fig2.update_yaxes(title_text="Total new Near users", secondary_y=True)
...
# Set y-axes titles
fig3.update_yaxes(title_text="Weekly new Near users", secondary_y=False)
fig3.update_yaxes(title_text="Total new Near users", secondary_y=True)
...
# Set y-axes titles
fig4.update_yaxes(title_text="Hourly active Near users", secondary_y=False)
...
# Set y-axes titles
fig5.update_yaxes(title_text="Daily active Near users", secondary_y=False)
fig5.update_yaxes(title_text="Total active Near users", secondary_y=True)
...
st.subheader('Executed Near transactions')
...
st.write('- Last month transactions (daily and cumulative)')
...
fig1.update_layout(
    title='Executed Near transactions',
    xaxis_tickfont_size=14,
    legend=dict(
        x=0,
        y=1.0,
...
# Set y-axes titles
fig1.update_yaxes(title_text="Hourly Near transactions", secondary_y=False)
fig1.update_yaxes(title_text="Total Near transactions", secondary_y=True)
...
# Set y-axes titles
fig2.update_yaxes(title_text="Daily Near transactions", secondary_y=False)
fig2.update_yaxes(title_text="Total Near transactions", secondary_y=True)
...
# Set y-axes titles
fig3.update_yaxes(title_text="Weekly Near transactions", secondary_y=False)
fig3.update_yaxes(title_text="Total Near transactions", secondary_y=True)
...
fig4.update_layout(
    title='Near transactions by type',
    xaxis_tickfont_size=14,
    legend=dict(
        x=0,
        y=1.0,
...
# Set y-axes titles
fig4.update_yaxes(title_text="Hourly Near transactions by type", secondary_y=False)
...
# Set y-axes titles
fig5.update_yaxes(title_text="Daily Near transactions by type", secondary_y=False)
fig5.update_yaxes(title_text="Total Near transactions by type", secondary_y=True)
...
# Set y-axes titles
fig4.update_yaxes(title_text=" Near Weekly transactions by type", secondary_y=False)
fig4.update_yaxes(title_text="Total Near transactions by type", secondary_y=True)
...
# Set y-axes titles
fig1.update_yaxes(title_text="Hourly NEAR fees", secondary_y=False)
fig1.update_yaxes(title_text="Total NEAR fees", secondary_y=True)
...
# Set y-axes titles
fig2.update_yaxes(title_text="Daily NEAR fees", secondary_y=False)
fig2.update_yaxes(title_text="Total NEAR fees", secondary_y=True)
...
# Set y-axes titles
fig3.update_yaxes(title_text="Weekly NEAR fees", secondary_y=False)
fig3.update_yaxes(title_text="Total NEAR fees", secondary_y=True)
...
fig1.update_layout(
    title='Near average transaction fees',
    xaxis_tickfont_size=14,
    legend=dict(
        x=0,
        y=1.0,
...
fig1.update_layout(
    title='Near average gas used (Peta)',
    xaxis_tickfont_size=14,
    legend=dict(
        x=0,
        y=1.0,
...
st.subheader('New and active Near contracts')
...
st.write('- Last month new and active contracts (daily and cumulative)')
...
fig1.add_trace(go.Bar(x=df['date'],
                y=df['new_contracts'],
                name='# of contracts',
                marker_color='rgb(249, 249, 180)'
                , yaxis='y'))
fig1.add_trace(go.Line(x=df['date'],
                y=df['cum_new_contracts'],
                name='# of contracts',
...
# Set y-axes titles
fig1.update_yaxes(title_text="Hourly new contracts", secondary_y=False)
fig1.update_yaxes(title_text="Total new contracts", secondary_y=True)
...
# Set y-axes titles
fig2.update_yaxes(title_text="Daily new contracts", secondary_y=False)
fig2.update_yaxes(title_text="Total new contracts", secondary_y=True)
...
# Set y-axes titles
fig3.update_yaxes(title_text="Weekly new contracts", secondary_y=False)
fig3.update_yaxes(title_text="Total new contracts", secondary_y=True)

tab1, tab2, tab3 = st.tabs(["Hourly new contracts", "Daily new contracts", "Weekly new contracts"])
...
tab1, tab2, tab3 = st.tabs(["Hourly active contracts", "Daily active contracts", "Weekly active contracts"])
